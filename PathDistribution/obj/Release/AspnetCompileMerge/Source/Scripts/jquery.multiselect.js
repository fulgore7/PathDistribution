...
(function($, undefined) {
   ...
   function insertImage(option, span) {
    ...
    function insertColorBox(option, span) {
        var optionImageSrc = option.getAttribute('data-color-class');
        if (optionImageSrc) {
            var div = document.createElement('div');
            div.setAttribute('class', 'box ' + optionImageSrc);
            span.insertBefore(div, span.firstChild);
        }
    }
